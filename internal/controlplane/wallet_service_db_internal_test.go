...
func TestWalletChallenge_CreateGetDelete(t *testing.T) {
	t.Parallel()

	t.Run("CreateWalletChallenge_Validates", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("CreateWalletChallenge_Success", func(t *testing.T) {
		t.Parallel()
		...
		if ch.Username != "alice" || ch.Address != "0xabc" {
	...
	t.Run("GetWalletChallenge_ExpiredAndSpent", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("GetWalletChallenge_Success", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("DeleteWalletChallenge_NoOpAndSuccess", func(t *testing.T) {
		t.Parallel()
