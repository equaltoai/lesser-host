...
func (s *Server) RegisterRoutes(app *apptheory.App) {
	...
	app.Get("/api/v1/soul/comm/mailbox/{agentId}/messages/{deliveryId}", s.handleSoulCommMailboxGet)
	app.Get("/api/v1/soul/comm/mailbox/{agentId}/messages/{deliveryId}/content", s.handleSoulCommMailboxContent)
	app.Post("/api/v1/soul/comm/mailbox/{agentId}/messages/{deliveryId}/read", s.handleSoulCommMailboxMarkRead)
	app.Post("/api/v1/soul/comm/mailbox/{agentId}/messages/{deliveryId}/unread", s.handleSoulCommMailboxMarkUnread)
	app.Post("/api/v1/soul/comm/mailbox/{agentId}/messages/{deliveryId}/archive", s.handleSoulCommMailboxArchive)
	app.Post("/api/v1/soul/comm/mailbox/{agentId}/messages/{deliveryId}/unarchive", s.handleSoulCommMailboxUnarchive)
	app.Post("/api/v1/soul/comm/mailbox/{agentId}/messages/{deliveryId}/delete", s.handleSoulCommMailboxDelete)
	...
	app.Get("/api/v1/soul/promotions/mine", s.handleSoulListMyPromotions, apptheory.RequireAuth())
	app.Get("/api/v1/soul/promotions/mine/events", s.handleSoulListMyPromotionLifecycleEvents, apptheory.RequireAuth())
	app.Get("/api/v1/soul/agents/{agentId}/promotion", s.handleSoulAgentGetPromotion, apptheory.RequireAuth())
	app.Get("/api/v1/soul/agents/{agentId}/promotion/events", s.handleSoulAgentListPromotionLifecycleEvents, apptheory.RequireAuth())
	app.Post("/api/v1/soul/agents/{agentId}/promotion/verify", s.handleSoulAgentPromotionVerify, apptheory.RequireAuth())
	...
	app.Post("/api/v1/soul/agents/register/{id}/mint-conversation/{conversationId}/finalize/preflight", s.handleSoulFinalizeMintConversationPreflight, apptheory.RequireAuth())
	...
	app.Post("/api/v1/soul/agents/{agentId}/mint-conversation/{conversationId}/finalize/preflight", s.handleSoulAgentFinalizeMintConversationPreflight, apptheory.RequireAuth())
