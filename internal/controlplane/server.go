...
func (s *Server) RegisterRoutes(app *apptheory.App) {
	...
	app.Get("/api/v1/soul/agents/{agentId}/channels", s.handleSoulPublicGetAgentChannels, apptheory.RequireAuth())
	app.Get("/api/v1/soul/agents/{agentId}/channels/preferences", s.handleSoulPublicGetAgentChannelPreferences, apptheory.RequireAuth())
	...
	app.Get(soulRecoveryInventoryPath, s.handleSoulInstanceRecoveryAgents)
	app.Get(soulRecoveryInventoryPath+"/{agentId}", s.handleSoulInstanceRecoveryAgent)
	...
	app.Post("/api/v1/soul/instance/agents/register/{id}/mint-conversation/{conversationId}/finalize", s.handleSoulInstanceFinalizeMintConversation)
	...
	app.Post("/api/v1/soul/agents/register/{id}/principal-declaration/preflight", s.handleSoulAgentRegistrationPrincipalDeclarationPreflight, apptheory.RequireAuth())
