/**
 * Vite config for the M15 Trust UI fixture page.
 *
 * Minimal config that serves ONLY `fixtures/m15-trust.html`. The entry
...
export default defineConfig({
	...
	build: {
		...
		rollupOptions: {
			input: path.resolve(webDir, 'fixtures/m15-trust.html'),
		},
	},
});
