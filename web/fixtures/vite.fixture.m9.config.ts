/**
 * Vite config for the M9 Configuration fixture page.
 *
 * Aliases the portalInstances API to mock data so InstanceConfig renders
 * with realistic configuration data without a backend.
 *
...
export default defineConfig({
	...
	resolve: {
		alias: {
			'src/lib/api/portalInstances': path.resolve(webDir, 'fixtures/__mocks__/portalInstancesM9Config.ts'),
