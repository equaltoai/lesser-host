/**
 * Vite config for the M3 ⌘K command palette fixture page.
 *
 * Minimal config that serves ONLY `fixtures/m3-cmdk.html`. No API mocks
 * are needed — the fixture component renders the CommandPalette directly
 * with static group data rather than mounting through PortalShell.
 *
...
export default defineConfig({
	...
	build: {
		...
		rollupOptions: {
			input: path.resolve(webDir, 'fixtures/m3-cmdk.html'),
		},
	},
});
