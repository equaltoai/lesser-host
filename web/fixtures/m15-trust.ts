...
const equaltoaiTrust = {
	...
	federation: {
		...
		severed: 1,
		peers: [
			{ domain: 'guild.greater.website', status: 'reachable' as const },
			{ domain: 'maeve-studio.greater.website', status: 'reachable' as const },
			{ domain: 'press-room.greater.website', status: 'warning' as const },
			{ domain: 'dev-sandbox.greater.website', status: 'reachable' as const },
			{ domain: 'partner-net.greater.website', status: 'severed' as const },
			{ domain: 'ops-hub.greater.website', status: 'reachable' as const },
			{ domain: 'data-lake.greater.website', status: 'warning' as const },
			{ domain: 'staging-env.greater.website', status: 'reachable' as const },
		],
	},
	signatures: {
		window_hours: 168,
...
const maeveStudioTrust = {
	...
	federation: {
		...
		severed: 0,
		peers: [
			{ domain: 'equaltoai.greater.website', status: 'reachable' as const },
			{ domain: 'guild.greater.website', status: 'reachable' as const },
			{ domain: 'press-room.greater.website', status: 'warning' as const },
		],
	},
