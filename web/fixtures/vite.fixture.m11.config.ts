/**
 * Vite config for the M11 Billing fixture page.
 *
 * Minimal config that serves ONLY `fixtures/m11-billing.html`. The entry
...
export default defineConfig({
	...
	build: {
		...
		rollupOptions: {
			input: path.resolve(webDir, 'fixtures/m11-billing.html'),
		},
	},
});
