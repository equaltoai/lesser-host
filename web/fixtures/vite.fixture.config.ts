/**
 * Vite config for the M1 primitives fixture page.
 *
 * Minimal config that serves ONLY `fixtures/m1-primitives.html`.
...
export default defineConfig({
	...
	build: {
		...
		rollupOptions: {
			input: path.resolve(webDir, 'fixtures/m1-primitives.html'),
		},
	},
});
