/**
 * Vite config for the M14 Soul Detail fixture page.
 *
 * Minimal config that serves ONLY `fixtures/m14-soul-detail.html`. The entry
...
export default defineConfig({
	...
	build: {
		...
		rollupOptions: {
			input: path.resolve(webDir, 'fixtures/m14-soul-detail.html'),
		},
	},
});
