# lesser-host Controls Matrix (custom — v0.1)
...
| Security | THR-5 THR-7 | SEC-1 | Baseline SAST stays green | Run a dedicated security/static scan gate (e.g., gosec via golangci-lint). | `bash gov-infra/verifiers/gov-verify-rubric.sh` (SEC-1) | `gov-infra/evidence/SEC-1-output.log` |
