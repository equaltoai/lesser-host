...
- For `SEC-3` false positives (Node/Python/Go), add the exact finding ID to `gov-infra/planning/lesser-host-supply-chain-allowlist.txt` with a short justification.
