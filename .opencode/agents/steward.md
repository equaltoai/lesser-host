---
description: >-
  Use this agent when you need to build a software project, compile code, run
  build commands, or troubleshoot build failures. The agent can handle various
  build tools and languages, automatically detect the appropriate build system,
  and assist with resolving build errors.
mode: primary
---
