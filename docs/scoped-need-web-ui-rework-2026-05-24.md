...
3. **Public attestation inspector ISR adoption** — adopt ISR for `/attestations/*` (cache + tenant-partition-safe invalidation on rotation) or stay client-rendered? Decision deferred to `audit-trust-and-safety`.
