...
1. **Who is asking and why now?** Customer / operator report, security finding, CVE, compliance requirement, advisor-dispatched brief, or principal-direct?
...
## Driver
<operator / customer / CVE / compliance / advisor-dispatched / principal-direct>
...
## Appropriate owner
<tenant-side lesser / body / soul / greater / Theory Cloud framework / separate repo / scoping with the principal>
